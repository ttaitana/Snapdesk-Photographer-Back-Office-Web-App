...
**F1 คิวถ่าย**
- [ ] หน้า list คิวถ่าย (เรียงตามวัน/เวลา) + ฟิลเตอร์ (วันนี้/สัปดาห์นี้/สถานะ)
- [ ] มุมมอง calendar (เดือน/สัปดาห์)
- [ ] หน้ารายละเอียดงาน: ถ่ายอะไร/แบบไหน
- [ ] checklist ของที่ต้องใช้ (เพิ่ม/ลบ/ติ๊ก)
- [ ] เก็บพิกัดสถานที่ + ปุ่มเปิด Google Maps นำทาง (deep link)
- [ ] form สร้าง/แก้คิว + auto-save draft

**F5 CRM**
- [ ] หน้า list ลูกค้า + ค้นหา/ฟิลเตอร์
- [ ] form เพิ่ม/แก้ลูกค้า (เบอร์/อีเมล/Line/IG/ช่องทางหลัก/โน้ต)
- [ ] หน้าลูกค้า: ประวัติงานทั้งหมด + ยอดใช้จ่ายรวม
- [ ] ปุ่มลัดติดต่อ (โทร/Line/IG) + สร้างงานใหม่จากหน้าลูกค้า

## P4 — ใบเสนอราคา (F2) + Tracking & แบ่งรายได้ (F3)

**F2 ใบเสนอราคา**
- [ ] Prisma model `Package` + CRUD แพ็กเกจ
- [ ] form สร้างใบเสนอราคา (เลือกลูกค้า + package หรือกรอกเอง)
- [ ] คำนวณราคารวม + ส่วนลด + มัดจำที่เสนอ อัตโนมัติ
- [ ] export PDF (โลโก้/ชื่อร้าน/เลขผู้เสียภาษี/วันหมดอายุ) — `@react-pdf/renderer`
- [ ] generate ข้อความสรุป (text) สำหรับก็อปส่ง chat
- [ ] ส่งใบเสนอราคา → อัปเดตสถานะงานเป็น QUOTED

**F3 tracking + แบ่งรายได้**
- [ ] timeline สถานะงาน (เปลี่ยน JobStatus)
- [ ] สถานะการเงินต่องาน: ราคารวม/จ่ายแล้ว/ยอดค้าง (สี) + ประวัติการจ่าย
- [ ] ปุ่มบันทึกรับเงินเร็ว (deposit/balance/full)
- [ ] สรุปยอดค้างรวมทุกงาน
- [ ] Prisma model `JobAssignment` (+ enum `ShareType`)
- [ ] assign สมาชิก + role ในงาน
- [ ] กำหนดสัดส่วน % หรือ fixed + คำนวณยอดต่อคนสด
- [ ] validate ผลรวมไม่เกินยอดงาน + แสดงส่วนของทีม (team pool)
